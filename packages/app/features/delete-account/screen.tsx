  ...
  return (
    <YStack flex={1} justifyContent="center" alignItems="center" space>
      ...
      <Paragraph size="$3" marginBottom="$1" px="$1">
        You are about to delete your <Text fontWeight="700">t4-app</Text> account associated with{' '}
        <Text fontWeight="700">{user.email}</Text>, if you press the button below all of your data
        will be erased from our servers immediately.
      </Paragraph>
